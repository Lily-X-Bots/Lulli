...
_buttons = {
    ...
    "oofdm": {
        "text": "About [Dual Mode](https://t.me/Lily_x_bots)",
        "buttons": [
            [
...
async def _(e):
    if not e.is_private:
        return
    await e.edit(
        "Click Authorise and send the code.\n\nYou can use your own CLIENT ID and SECRET by [this](https://t.me/Lily_x_bots)",
        buttons=[
            [
